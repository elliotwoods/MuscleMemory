...
void step(int step_togo)
{
    ...
    printf("Start (now %d.) Go to %d step\n",now_step, step_togo);
    ...
    while(step_left>0)
    {
        ...
        {   
            ...
            printf("now %d, stp_left %d .. phase %d\n", now_step,step_left,now_phase());
            if(step_left==0)
            {
        ...
        {   
            ...
            dac_output_voltage(DAC_GPIO25_CHANNEL, _vref[0]);
            dac_output_voltage(DAC_GPIO26_CHANNEL, _vref[1]); 
            printf("%d,%d,%d,%d .. phase %d Now %d\n",
                _sine_array[0],_sine_array[1],_sine_array[2],_sine_array[3],
                _phase,now_step);
        }
    }
}
